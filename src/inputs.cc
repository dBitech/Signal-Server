...
int LoadSDF_SDF(const char *name) {
...
int LoadSDF_BZ(const char *name) {
...
int LoadSDF_GZ(const char *name) {
...
int LoadPAT(const char *az_filename, const char *el_filename) {
...
int LoadUDT(const char *filename) {
